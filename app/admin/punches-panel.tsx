...
const dateFormatter = new Intl.DateTimeFormat('pt-BR', { timeZone: APP_TIME_ZONE });
const timeFormatter = new Intl.DateTimeFormat('pt-BR', { timeZone: APP_TIME_ZONE, hour: '2-digit', minute: '2-digit', second: '2-digit' });
const dateTimeFormatter = new Intl.DateTimeFormat('pt-BR', { timeZone: APP_TIME_ZONE, dateStyle: 'short', timeStyle: 'short' });
function formatDate(timestamp: string) { return dateFormatter.format(new Date(timestamp)); }
function formatTime(timestamp: string) { return timeFormatter.format(new Date(timestamp)); }
